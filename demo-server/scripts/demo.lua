...
Net:on("actor_interaction", function (event)
    ...
    if event.actor_id == "bat" and event.button == 0 and bat_active[event.player_id] == false then
        ...
        games.animate_ui_element("points", event.player_id, {opacity = 255, r = 125,g = 0,b= 122, color_mode = 1}, {opacity = 255, r = 255, g = 125, b = 255, color_mode = 1},2, AnimationEngine.AnimEnums.EasingFns.ease_in, nil, true , true, AnimationEngine.AnimEnums.EasingFns.ease_out)
